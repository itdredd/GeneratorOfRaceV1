    ...
    def GeneratorSkills(self, maxSkills):
        ...
        while z < maxSkills:
            ...
            if temp == listSkills.index('speed'):
                ...
                tempList.append('vampire')
            elif temp == listSkills.index('longjump'):
                valueOfSkill = random.randrange(110, 600)
                additionalValue = random.randrange(10, 60)
                print('\t\"skill' + str(int(z+1)) + '\"          \"longjump =\"\n\t\"setting' + str(int(z+1)) + '\"', '       \"' + str(float(valueOfSkill)) + ';' + str(float(valueOfSkill + additionalValue)) + ';' + str(float(valueOfSkill + additionalValue * 2)) + ';' + str(float(valueOfSkill + additionalValue * 3)) + '\"')
                tempList.append('longjump')
