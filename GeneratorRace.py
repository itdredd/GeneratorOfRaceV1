...
rand = 0
temp = -1
while z <= amountSkills or temp == -1 and temp != rand:
    ...
    if rand == skills.index('paralyze'):
        ...
        if paralyzeChange < 30:
            additionalValueChange = random.randrange(10, 15)
        print('"paralyze ="\n"', paralyzeValue, paralyzeChange, ';', round(paralyzeValue + additionalValue, 2),
              paralyzeChange + additionalValueChange, ';', round(paralyzeValue + additionalValue * 2, 2),
              paralyzeChange + additionalValueChange * 2, ';', round(paralyzeValue + additionalValue * 3, 2),
              paralyzeChange + additionalValueChange * 3, ';')
    # else:
    #     print(rand)
    #     print("Need add soon...")
    temp = rand
